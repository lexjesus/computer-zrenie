...
signals:
    ...
    void updateStatus(float fps, cv::Scalar cv_arr_mean, cv::Scalar arr_mean, cv::Scalar cv_arr_std_dev, cv::Scalar arr_std_dev);
...
private:
    ...
    void getMeanAndStdDev(cv::Mat &frame);
